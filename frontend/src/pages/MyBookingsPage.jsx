                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-start justify-between gap-2 mb-1">
                        <div>
                          <h3 className="font-bold text-base">{b.club?.name}</h3>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-4 gap-y-1 mt-2 text-xs text-white/50">
                        <span>📅 {new Date(b.visitDate + 'T00:00:00').toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' })}</span>
                        ...
                        {b.transportType !== 'none' && <span>🚗 {b.transportType}</span>}
                        {b.payment && <span className={b.payment.status === 'captured' ? 'text-green-400' : 'text-yellow-400'}>
                  ...
                  {['pending', 'confirmed'].includes(b.status) && (
                    <div className="mt-4 pt-4 border-t border-white/5 flex justify-end">
                      <button
                        ...
                        className="text-sm text-red-400 hover:text-red-300 transition-colors disabled:opacity-50 border border-red-400/20 px-4 py-1.5 rounded-lg hover:bg-red-400/10"
                      >
